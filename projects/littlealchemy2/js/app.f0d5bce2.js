(function (t) {
    function e(e) {
      for (var i, n, o = e[0], c = e[1], l = e[2], h = 0, d = []; h < o.length; h++) (n = o[h]), Object.prototype.hasOwnProperty.call(a, n) && a[n] && d.push(a[n][0]), (a[n] = 0);
    ...
    (c.e = function (t) {
      var e = [],
        s = { "completion-animation": 1, "end-animation": 1 };
      n[t]
        ? e.push(n[t])
        : 0 !== n[t] &&
          s[t] &&
            ...
            (n[t] = new Promise(function (e, s) {
              ...
              (u.rel = "stylesheet"),
                ...
                (u.onerror = function (e) {
                  ...
                  (r.code = "CSS_CHUNK_LOAD_FAILED"), (r.request = i), delete n[t], u.parentNode.removeChild(u), s(r);
                }),
                (u.href = a);
    ...
    "152b": function (t, e, s) {
      ...
      const n = ["EMAIL", "TEXT", "PASSWORD", "FILE"],
        a = (t) => {
          ...
          let r = !0;
          (("INPUT" === s && n.includes(a)) || "TEXTAREA" === s) && (r = e.readOnly || e.disabled), r && t.preventDefault();
        },
        r = (t) => {
    ...
    1663: function (t, e, s) {
      ...
      var i = s("2b0e"),
        ...
        h = s("06c5");
      const d = [
          { event: "orientationchange", handler: (t) => window.setTimeout(() => t("RESIZE"), 350) },
          { event: "beforeunload", handler: "UNLOAD" },
          { event: "pagehide", handler: "UNLOAD" },
          {
            event: "blur",
            handler: (t) =>
              l()(() => {
          ...
          { event: "focus", handler: "FOCUS" },
          { event: "online", handler: "ONLINE" },
          { event: "offline", handler: "OFFLINE" },
          { event: "popstate", handler: "BACK_BUTTON" },
          {
            parent: "document",
    ...
    "22a7": function (t, e, s) {
      ...
      class r {
        analyze(t, e) {
          ...
          return { progress: a(l), base: n, final: c, primes: o, timestamps: i };
        }
        analyzeHistory(t, e) {
          const s = {},
            a = [];
          return (
            e.forEach(({ mother: e, father: r, timestamp: o }) => {
              const c = Object(n["c"])([e, r]),
                l = Object(i["b"])(t, c);
              l.forEach((t) => {
                s.hasOwnProperty(t) || ((s[t] = !0), a.push({ id: t, timestamp: o }));
              });
            }),
            { totalProgress: Object.keys(s), timestamps: a }
          );
        }
        analyzeProgress(t, e) {
          const s = [],
    ...
    2540: function (t, e, s) {
      ...
      const a = () => {
          ...
          (t && t.popup) || window.history.pushState({ popup: !0 }, "");
        },
        r = () => {
          const t = window.history.state;
      ...
      class h {
        ...
        onShow(t) {
          a(), o["a"].emit("POPUP_SHOW", t), c["a"].handler && c["a"].handler.disable();
        }
        onHide(t) {
          l || r(), o["a"].emit("POPUP_HIDE", t), c["a"].handler && c["a"].handler.enable(), t === i["ENCYCLOPEDIA"] && o["a"].emit("ENCYCLOPEDIA_POPUP_HIDE");
        }
        onHidePromise() {
    ...
    "2ae7": function (t, e, s) {
      ...
      function i() {
        const t = document.createElement("fakeelement"),
          e = { animation: "a", WebkitAnimation: "webkitA" },
    ...
    "3b56": function (t, e, s) {
      ...
      const o = {
          key: i["a"].PROGRESS,
          parse: (t) => {
            const e = t.map(([t, e, s]) => ({ father: t, mother: e, timestamp: s }));
            return e;
          },
          prepare: (t) => {
        ...
        l = { key: i["a"].WORKSPACE_INACTIVE, parse: (t) => t, prepare: (t) => ({ workspaceFinal: t.getters.workspaceFinal, workspaceExhausted: t.getters.workspaceExhausted, exhausted: t.getters.exhaustedVisible }), watch: [] },
        h = { key: i["a"].RESET_TIMESTAMP, parse: (t) => t, prepare: (t) => t.getters.resetTimestamp, watch: [] },
        d = { key: i["a"].SETTINGS, parse: (t) => t, prepare: (t) => t.state.settings, watch: [] },
        u = { key: i["a"].ENCYCLOPEDIA, parse: (t) => t, prepare: (t) => t.state.encyclopedia, watch: [] },
        m = { key: i["a"].STATS, parse: (t) => t, prepare: (t) => ({ firstLaunch: t.getters.firstLaunch, sessionsCount: t.getters.sessionsCount }), watch: [] },
        p = { key: i["a"].TUTORIALS, parse: (t) => t, prepare: (t) => ({ shownText: t.getters.tutorialTextShown }), watch: [] };
      var g = { [i["a"].PROGRESS]: o, [i["a"].WORKSPACE]: c, [i["a"].WORKSPACE_INACTIVE]: l, [i["a"].RESET_TIMESTAMP]: h, [i["a"].SETTINGS]: d, [i["a"].ENCYCLOPEDIA]: u, [i["a"].STATS]: m, [i["a"].TUTORIALS]: p };
      s.d(e, "a", function () {
        return i["a"];
      });
      ...
      class f {
        ...
        initSaveTriggers() {
          E.forEach((t) => a["a"].on(t, this.save)), Object.values(this.entries).forEach(({ watch: t }) => t.forEach((t) => this.$store.watch((e, s) => s[t], this.save)));
        }
        saveSingle(t, e) {
          Object(n["b"])(t, e);
        }
    ...
    "5c57": function (t, e, s) {
      ...
      var l = s("53b2"),
        h = s("1663"),
        d = s("b7ba");
      const u = { active: null, activeFinal: [], middleFinal: [], activeExhausted: [] },
        m = {
          state: u,
          getters: {
          ...
          actions: {
            ...
            async mixOccured({ dispatch: t, getters: e }) {
              await Object(a["c"])(10), e.mixStatus !== d["a"] && (e.mixStatus !== d["b"] ? e.mixStatus === d["c"] && (o(), t("animationChange", l["c"])) : h["a"].emit("ANIMATION_MIXED_START"));
            },
            async animationFusionMiddle({ dispatch: t, getters: e }) {
              t("animationNewCheck"), e.mixHasNewChildren || (t("workspaceHandleMixResult", { removeParents: !0 }), await Object(a["c"])(250), t("workspaceExhaustedCheck"));
            },
            ...
            async animationNewEnding({ dispatch: t }, { removeParents: e = !0 } = {}) {
              t("workspaceHandleMixResult", { removeParents: e }), Object(a["c"])(250), t("workspaceExhaustedCheck");
            },
      ...
      var b = f;
      const y = { workspaceBox: { width: -1, height: -1 }, libraryBox: { width: -1, height: -1, margin: -1 } },
        v = {
          state: y,
          getters: { workspaceBoxDimensions: (t) => t.workspaceBox, libraryBoxDimensions: (t) => t.libraryBox, libraryBoxMargin: (t) => t.libraryBox.margin },
          actions: {
      ...
      var w = v,
        I = s("3b56");
      const A = I["b"].load(I["a"].ENCYCLOPEDIA) || { encyclopediaShown: -1 },
        T = {
          state: A,
          getters: { encyclopediaTimestamp: (t) => t.encyclopediaShown },
          actions: {
      ...
      const _ = "#",
        ...
        R = (t, e, s) => s.map((s) => ({ id: s, exhausted: L(t, e, s) })),
        D = I["b"].load(I["a"].WORKSPACE_INACTIVE),
        N = { exhausted: {}, visible: null !== D ? D.exhausted : [] },
        k = {
          state: N,
          getters: {
            ...
            async mixNew({ commit: t, getters: e }, { parents: s }) {
              await Object(a["c"])(30),
                s.forEach((s) => {
                  ...
                  i && (t("ELEMENT_SET_EXHAUSTED", { id: s, exhausted: i }), t("EXHAUSTED_VISIBLE_ADD", s));
                });
            },
            resetProgress({ commit: t, getters: e }) {
              const s = e.elementsIds.filter((t) => e.elementIsExhausted(t)).map((t) => ({ id: t, exhausted: !1 }));
      ...
      var K = new Y();
      const z = { dragging: null, over: null, listening: [], static: { [F["e"]]: { id: F["e"], dimensions: { width: 0, height: 0 }, position: { x: 0, y: 0 } } }, draggableHelper: null },
        V = {
          state: z,
          getters: {
          ...
          actions: {
            ...
            dragEnd({ commit: t, dispatch: e, getters: s }, { position: i, simulated: n }) {
              t("DRAG_POSITION", Object(j["a"])({ dragged: s.draggedElement }, i)),
                U["a"].onDragEnd(n),
                t("DRAG_END"),
                H()(() => {
          ...
          mutations: {
            ...
            STATIC_DROPPABLE_UPDATE(t, { id: e, width: s, height: i, x: n, y: a }) {
              const r = t.static[e];
              (r.dimensions.width = s), (r.dimensions.height = i), (r.position.x = n), (r.position.y = a);
            },
      ...
      var X = V;
      const q = { isReady: !1, playing: !1, online: !0, user: null, userProgressSynced: !1, visible: !0 },
        Q = {
          state: q,
          getters: {
      ...
      class tt {
        ...
        addNewParents([t, e]) {
          this.addEntry({ father: t, mother: e, timestamp: Date.now() });
        }
        addEntry(t) {
      ...
      var st = et,
        it = s("cf19");
      const nt = { historyTimestamp: 0, resetTimestamp: I["b"].load(I["a"].RESET_TIMESTAMP) || -1 },
        at = {
          state: nt,
          getters: {
          ...
          actions: {
            historyReload({ dispatch: t }) {
              t("progressCalculate"), Z["a"].scrollTop(), h["a"].emit("SYNC_PROGRESS_CHANGED");
            },
          ...
          mutations: {
            ...
            RESET_PROGRESS(t) {
              st.reset(), (t.historyTimestamp = Date.now()), (t.resetTimestamp = Date.now());
            },
            RESET_TIMESTAMP(t, e) {
              t.resetTimestamp = e;
            },
      ...
      var rt = at,
        ...
        ct = s("a799");
      const lt = ["status"],
        ht = { status: null, father: null, mother: null, children: [], baseChildren: [] },
        dt = {
          state: ht,
          getters: {
          ...
          actions: {
            ...
            mixFail({ dispatch: t }) {
              t("mixOccured", { status: d["a"] }), h["a"].emit("MIX_FAIL");
            },
            mixMixed({ dispatch: t }, { children: e }) {
              t("mixOccured", { status: d["b"], children: e.map((t) => ({ id: t })) }), h["a"].emit("MIX_MIXED");
            },
            mixNew({ dispatch: t }, { children: e, positions: s }) {
              o();
              const i = e.map((t, e) => ({ id: t, position: s[e] }));
              t("mixOccured", { status: d["c"], children: i }), h["a"].emit("MIX_NEW");
            },
            mixBase({ commit: t, dispatch: e, getters: s }, { children: i, positions: n }) {
              const a = i.map((t, e) => ({ id: t, position: n[e] })),
                r = i.filter((t) => s.elementById(t).base);
              t("MIX_SET_CHILDREN", a), t("MIX_SET_BASE_CHILDREN", r), e("progressNewBase", r);
            },
            mixOccured({ commit: t, getters: e }, { status: s, children: i = [] }) {
              ...
              t("MIX_OCCURED", { status: s, father: n, mother: a, children: i });
            },
      ...
      var ut = dt;
      const mt = { enabled: !0, current: null, playing: !1 },
        pt = {
          state: mt,
          getters: { isAudioEnabled: (t) => t.enabled, isMusicPlaying: (t) => t.playing, currentMusic: (t) => t.current },
          actions: {
            musicSet({ commit: t }, e) {
              t("MUSIC_SET", e);
            },
      ...
      var gt = pt,
        Et = s("ded8");
      const ft = { library: [], rendered: !1, sortBy: "alphabet" },
        bt = {
          state: ft,
          getters: { library: (t) => t.library, hasLibrary: (t) => !!t.library.length, hasInLibrary: (t) => (e) => t.library.includes(`${e}`), librarySortBy: (t) => t.sortBy, isLibraryRendered: (t) => t.rendered },
          actions: {
      ...
      var yt = bt,
        vt = s("54cb"),
        wt = s("22a7");
      const It = { progress: {}, final: {}, prime: [], base: [], total: [] },
        At = {
          state: It,
          getters: {
            ...
            elementTimestamp: (t) => (e) => {
              for (let s = t.total.length - 1; s >= 0; s--) if (t.total[s].id === e) return t.total[s].timestamp;
              return 0;
            },
          ...
          actions: {
            ...
            mixNew({ commit: t, getters: e }, { parents: s, children: i }) {
              i.forEach((s) => {
                ...
                window.setTimeout(() => h["a"].emit("ENCYCLOPEDIA_MIX_NEW", { parents: s, children: i, timestamp: Date.now() }), 60);
            },
            progressNewBase({ commit: t, getters: e }, s) {
              const i = s.filter((t) => !e.base.includes(t));
              i.forEach((e) => t("PROGRESS_BASE", { id: e, timestamp: Date.now() })), h["a"].emit("ENCYCLOPEDIA_MIX_BASE", i);
            },
          },
          mutations: {
            PROGRESS_ANALYZED(t, { progress: e, base: s, final: i, primes: n, timestamps: r }) {
              (t.progress = e), (t.base = s), (t.prime = n), (t.final = i), (t.total = r), Object(a["A"])("progress", "analyzed", t);
            },
            PROGRESS_NEW(t, e) {
              i["a"].set(t.progress, e, !0), t.total.push({ id: e, timestamp: Date.now() });
            },
            PROGRESS_FINAL(t, e) {
              t.final.hasOwnProperty(e) || (i["a"].set(t.final, e, !0), t.total.push({ id: e, timestamp: Date.now() }));
            },
            PROGRESS_BASE(t, { id: e, timestamp: s }) {
              t.base.push(e), t.total.push({ id: e, timestamp: s });
            },
            PROGRESS_PRIMES(t, e) {
              t.prime = e;
            },
      ...
      const St = { query: null },
        _t = {
          state: St,
          getters: { searchQuery: (t) => t.query, isSearchActive: (t) => null !== t.query },
          actions: {
            search({ commit: t }, e) {
              t("SEARCH", e);
            },
      ...
      var Ot = _t;
      const xt = Object(j["a"])({ music: !0, sfx: !0 }, I["b"].load(I["a"].SETTINGS) || {}),
        Pt = {
          state: xt,
          getters: { playSfx: (t) => t.sfx, playMusic: (t) => t.music },
          actions: {
      ...
      var Ct = Pt;
      const Lt = { firstLaunch: Date.now(), sessionsCount: 1, session: { initialProgress: 0, start: Date.now(), streak: 0, fails: 0, failsStreak: 0 } },
      ...
      var Nt = Dt,
        kt = s("6953");
      const Mt = Object(j["a"])({ tutorial: null, tutorialsFinished: !1, currentText: null, currentTextPosition: null, shownText: [] }, I["b"].load(I["a"].TUTORIALS)),
        jt = {
          state: Mt,
          getters: {
      ...
      var $t = jt,
        Ht = s("b2eb"),
        Bt = s("2540");
      const Ft = { popupName: null, popupData: null, isOverlayActive: !1 },
        Gt = {
          state: Ft,
          getters: {
            popup: (t) => t.popupName,
          ...
          actions: {
            popupToggle({ dispatch: t, getters: e }, s) {
              e.popup !== s ? (null !== e.popup && t("popupHide", void 0), H()(() => t("popupShow", s))) : t("popupHide", void 0);
            },
            popupShow({ commit: t, dispatch: e }, s) {
              s === Ht["ENCYCLOPEDIA"] && e("encyclopediaShow"), t("UI_POPUP_SHOW", s), Bt["a"].onShow(s);
            },
            ...
            async popupShowNext({ dispatch: t }, { name: e, data: s = null }) {
              t("popupHide", { hideOverlay: !1 }), await Object(a["c"])(Ht["DELAY"]), s ? t("popupShowWithData", { name: e, data: s }) : t("popupShow", e);
            },
            popupHide({ commit: t, getters: e }, { hideOverlay: s = !0 } = {}) {
              null !== e.popup && (Bt["a"].onHide(e.popup), t("UI_POPUP_HIDE", s));
            },
          },
          mutations: {
            UI_POPUP_SHOW(t, e) {
      ...
      var Ut = Gt,
        Wt = s("c561"),
        Yt = s("b10a");
      const Kt = { elements: I["b"].load(I["a"].WORKSPACE) || [], elementsPrevious: [] },
        zt = {
          state: Kt,
          getters: {
          ...
          actions: {
            ...
            workspaceElementClone({ dispatch: t, commit: e, getters: s }, i) {
              ...
              e("DRAGGABLE_HELPER_PREPARE", { helper: s.draggableHelperElement, elementId: a.elementId, position: { x: n.position.x + r.x * F["a"] * 2, y: n.position.y + r.y * F["a"] } }),
            ...
            workspaceHandleMixResult({ dispatch: t, getters: e }, { removeParents: s = !0 } = {}) {
              ...
              const i = e.mixChildren,
                n = i.map((t) => Object(j["a"])(Object(j["a"])({}, Wt["a"]), {}, { id: Object(B["a"])(t.id), elementId: t.id, position: t.position })),
                a = [],
                r = [],
                o = [];
              n.forEach((t) => {
          ...
          mutations: {
            ...
            DRAGGABLE_HELPER_SET(t, e) {
              e && t.elements.push(Object(j["a"])(Object(j["a"])({}, Wt["a"]), {}, { id: e, elementId: G["a"], position: { x: -500, y: -500 } }));
            },
      ...
      var Vt = zt;
      const Xt = Object(j["a"])({ workspaceFinal: [], workspaceFinalPrevious: [], workspaceExhausted: [], workspaceExhaustedPrevious: [], needsGameCompletionAnimation: !1 }, I["b"].load(I["a"].WORKSPACE_INACTIVE) || {});
        ...
        Qt = {
          ...
          mutations: {
            ...
            WORKSPACE_FINAL_REMOVE(t, e) {
              (t.workspaceFinal = t.workspaceFinal.filter(({ elementId: t }) => e !== t)), (t.needsGameCompletionAnimation = !0);
            },
            WORKSPACE_EXHAUSTED_ADD(t, e) {
              t.workspaceExhausted = t.workspaceExhausted.concat(e);
            },
            WORKSPACE_EXHAUSTED_REMOVE(t, e) {
              (t.workspaceExhausted = t.workspaceExhausted.filter(({ elementId: t }) => e !== t)), (t.needsGameCompletionAnimation = !0);
            },
      ...
      const Zt = {
        ...
        te = new n["b"].Store({ modules: Zt, strict: !1 }),
        ee = (Object(n["a"])(), n["d"]);
      n["c"];
      e["a"] = te;
    },
    ...
    6953: function (t, e, s) {
      ...
      var i = s("d257"),
        ...
        r = s("7543"),
        o = s("93e8");
      const c = { horizontal: 1, vertical: 1 },
        l = [
          {
      ...
      class h {
        ...
        show({ id: t, getPosition: e }) {
          ...
          this.$store.dispatch("tutorialTextShow", { id: t, position: s });
        }
        onReset() {
    ...
    "6e2e": function (t, e, s) {
      ...
      class a {
        ...
        async loadBase() {
          ...
          return (this.elements = t), Object(n["A"])("base", "elements loaded", { elements: t }), this.elements;
        }
        async loadDescriptions() {
          const t = await this.loader.loadDescriptions();
          return (this.descriptions = t), Object(n["A"])("base", "descriptions loaded", { descriptions: t }), this.descriptions;
        }
        async loadTags() {
          const t = await this.loader.loadTags();
          return (this.tags = t), Object(n["A"])("base", "tags loaded", { tags: t }), this.tags;
        }
        elementAdd(t, e) {
      ...
      class r extends a {
        ...
        async loadTextElements() {
          ...
          return (this.textElements = t), Object(n["A"])("base", "text elements loaded", { elements: t }), this.textElements;
        }
      }
    ...
    "6eebf": function (t, e, s) {
      ...
      class u {
        ...
        init(t, e, s) {
          (this.firebase = t),
            ...
            this.initEvents(),
            c["a"].once("PLAY", async () => {
              await Object(r["c"])(h), this.shouldLoad(e) && (await this.load(), this.onLoaded(), this.shouldRequestPermission(e) && this.request());
            });
        }
        initEvents() {
      ...
      class y {
        constructor() {
          (this.unsubscribe = null),
            (this.onAuthStateChanged = (t, e) => {
              ...
              const s = { isAnonymous: t.isAnonymous, uid: t.uid, name: t.displayName, email: t.email, emailVerified: t.emailVerified, avatar: t.photoURL, providerId: e ? e.providerId : "", isNewUser: !!e && e.isNewUser };
              this.onLoggedIn(s);
            }),
            (this.onAuthStateChanged = g()(this.onAuthStateChanged, 250, { leading: !0, trailing: !1 }));
        }
        async init(t, e, s) {
        ...
        loginFacebook() {
          ...
          return t.setCustomParameters({ display: "popup" }), this.loginWithProvider(t);
        }
      ...
      class A {
        ...
        async init(t) {
          (this.$store = t),
            ...
            await this.app.init(),
            (this.auth = new v()),
            this.auth.init(this.firebase, this.$store, { onLogin: this.onLogin, onLogout: this.onLogout }),
    ...
    7543: function (t, e, s) {
      ...
      const i = (t, e) => Math.sqrt((t.x - e.x) * (t.x - e.x) + (t.y - e.y) * (t.y - e.y)),
        n = (t, e) => ({ x: t.x + e.width / 2, y: t.y + e.height / 2 }),
        a = (t, e, s, i, n = "half") => {
          const a = t.x,
            r = t.y,
            o = a + e.width,
    ...
    "7d61": function (t, e, s) {
      ...
      var i = s("53b2");
      const n = {
        [i["c"]]: { middle: "fusion-core-come-back", end: "fusion-core-out" },
        [i["f"]]: { start: "background-in", end: "background-out", hideContent: "hide-popup-content", showContent: "hide-popup-content-timer", baseShow: "item-unlocked-show", baseHide: "item-unlocked-hide" },
        [i["b"]]: { delete: "dematerialize-core-in", end: "dematerialize-timer", encyclopedia: "materialize-core-out", encyclopediaId: "animation-final-encyclopedia" },
        [i["a"]]: { transitionMiddle: "transform", revertMiddle: "opacity" },
        [i["e"]]: { end: "ending-hide" },
        [i["d"]]: { middle: "cover-show", end: "completion-hide" },
      };
    },
    "84df": function (t, e, s) {
      "use strict";
    ...
    "93e8": function (t, e, s) {
      ...
      const i = (t) => {
          const e = 3,
            ...
            n = Math.floor(t.x / s),
            a = Math.floor(t.y / i);
          return { horizontal: n, vertical: a };
        },
        n = (t) => {
          const e = i(t),
            s = e.horizontal,
            n = e.vertical;
          return { horizontal: s, vertical: n };
        },
        a = (t) => "string" === typeof t;
    },
    a097: function (t, e) {},
      ...
      class c {
        ...
        getDropMixResult() {
          ...
          const t = this.parents,
            ...
            s = !e.length,
            a = { parents: t, children: e, positions: [] };
          if (s) return Object(i["a"])(Object(i["a"])({}, a), {}, { status: "mixFail" });
          const r = this.$store.getters.hasMixed(t);
          if (r) return Object(i["a"])(Object(i["a"])({}, a), {}, { status: "mixMixed" });
          const o = this.getChildrenPositions(e.length);
          return Object(i["a"])(Object(i["a"])({}, a), {}, { status: "mixNew", positions: o });
        }
        getBaseElementsMixResult(t) {
          ...
          return { base: e, children: s, positions: i };
        }
    ...
    b10a: function (t, e, s) {
      ...
      class u {
        ...
        getCloneDirections(t, e) {
          let s = 1,
            i = -1;
          return t.x + e.width + d >= this.workspacePositionRight && (s *= -1), t.y <= d && (i *= -1), { x: s, y: i };
        }
        addToWorkspace(t) {
          this.$store.dispatch("workspaceElementsAdd", [Object(i["a"])(Object(i["a"])({}, o["a"]), {}, { id: Object(r["a"])(t), elementId: t, position: this.calculateNewElementPosition() })]);
        }
        calculateNewElementPosition() {
          ...
          while (a > 0 && a < this.height) {
            for (let e = s; e > 0; e -= t) if (this.isEmptyPosition({ x: e, y: a })) return { x: e, y: a };
            (n *= -1), n >= 0 && (n += e), (a = i + n);
          }
          return { x: s, y: i };
        }
    ...
    b2eb: function (t, e, s) {
      ...
      const i = 150,
        ...
        p = "RATING_REVIEW",
        g = "RATING_FEEDBACK",
        E = { [a]: a, [r]: r, [o]: o, [c]: c, [l]: l, [h]: h, [m]: m, [p]: p, [g]: g, [d]: d, [u]: u };
    },
    b7ba: function (t, e, s) {
      "use strict";
      s.d(e, "c", function () {
    ...
    c561: function (t, e, s) {
      ...
      const i = { id: "", elementId: "", position: { x: 0, y: -500 } };
    },
    c97d: function (t, e, s) {
      "use strict";
      s("e6cf");
      ...
      class o {
        ...
        init(t) {
          return (
            (this.element = t), (this.element.style.WebkitOverflowScrolling = "touch"), (this.element.style.overflowY = "scroll"), (this.element.style.overflowX = "hidden"), (this.element.style.transform = "translateZ(0)"), Promise.resolve()
          );
        }
        reinitialize() {
        ...
        onScroll(t) {
          (this._callback = () => t({ y: this.element.scrollTop })), this.element.addEventListener("scroll", this._callback, a["a"]);
        }
        offScroll() {
      ...
      class m {
        ...
        async initInstance(t) {
          ...
          return (this.iscroll = new e(`#${t.id}`, { bindToWrapper: !1, mouseWheel: !0, deceleration: 0.0011, resizePolling: 2e3, disablePointer: !0, disableMouse: !1, disableTouch: !1, bounceTime: 300, probeType: 3 })), this.iscroll;
        }
        async load() {
        ...
        onScroll(t) {
          (this._callback = h()(() => {
            ...
            e + this.iscroll.wrapperHeight > this.iscroll.scrollerHeight || t({ y: e });
          }, u)),
    ...
    cd49: function (t, e, s) {
      ...
      var m = u,
        ...
        v = s("b2eb"),
        w = s("2de2");
      const I = { id: "", offline: !1, immediate: !1, title: "", img: "", text: "", conditions: [], action: null, timestamp: Date.now() },
        A = 1,
        T = 1e3 * A,
        S = 60 * T,
        _ = 60 * S,
        O = 24 * _,
        x = "https://littlealchemy2.com/public/news/v1/w",
        P = "news",
        C = 1,
        L = 3 * O,
        R = 300;
      class D {
        constructor() {
          (this._promise = null),
            (this.initContent = async () => {
              if ((this.fetch().then(this.fillCache), this.$store.getters.sessionsCount <= C)) return;
              const t = await this.load(),
        ...
        show(t) {
          b()(() => this.$store.dispatch("popupShowWithData", { name: v["NEWS"], data: t })),
            g["a"].once("PLAY", () => {
        ...
        save() {
          Object(y["b"])(P, { shown: this.shown, cached: this.cached, timestamp: this.lastShownTimestamp });
        }
        fetch() {
          return null !== this._promise ? this._promise : ((this._promise = Object(o["d"])(x)), this._promise);
        }
        get storage() {
          return Object(y["a"])(P) || {};
        }
      ...
      var $ = s("b10a");
      const H = { addToWorkspace: ({ id: t }) => $["a"].addToWorkspace(t) };
      var B = H,
        F = s("152b");
      const G = (t, e, s) => Object(E["a"])({ trigger: t, command: e }, s),
        U = [
          G("ENCYCLOPEDIA_ELEMENTS", "elements", { prepare: () => ({ elements: c["a"].elements }) }),
          G("ENCYCLOPEDIA_TAGS", "tags", { prepare: () => ({ tags: c["a"].tags }) }),
          G("ENCYCLOPEDIA_DESCRIPTIONS", "descriptions", { prepare: () => ({ descriptions: c["a"].descriptions }) }),
          G("ENCYCLOPEDIA_SHOW_ITEM", "showItem", {
            prepare: (t, e) => ({ id: e }),
            callback: async (t) => {
              Object(F["c"])(document.body, "longpress"), await Object(o["c"])(60), t.dispatch("popupShow", v["ENCYCLOPEDIA"]);
            },
          }),
          G("ENCYCLOPEDIA_SHOW_HELP", "showHelp", {
            prepare: (t, e) => ({ id: e }),
            callback: async (t) => {
              await Object(o["c"])(60), t.dispatch("popupShow", v["ENCYCLOPEDIA"]);
            },
          }),
          ...
          G("ENCYCLOPEDIA_MIX_BASE", "mixBase", { prepare: (t, e) => ({ elements: e }) }),
          G("ENCYCLOPEDIA_MIX_NEW", "mixNew", {
            prepare: (t, e) => {
              const s = e.parents.filter((e) => t.getters.elementIsExhausted(e));
              return Object(E["a"])(Object(E["a"])({}, e), {}, { exhausted: s });
            },
          }),
          G("ENCYCLOPEDIA_PROGRESS_ANALYZED", "progress", {
            prepare: (t) => {
              const e = t.getters.totalProgressElements.filter((e) => t.getters.elementIsExhausted(e));
              return { history: t.getters.history, progress: t.getters.progress, timestamps: t.getters.total, prime: t.getters.prime, base: t.getters.base, final: t.getters.final, exhausted: e };
            },
          }),
        ];
      var W = U;
      class Y {
        ...
        initCommands() {
          W.forEach((t) => {
            g["a"].on(t.trigger, (e) => {
              let s = {};
              j(t.prepare) && (s = t.prepare(this.$store, e)), this.post(t.command, s), j(t.callback) && t.callback(this.$store);
            });
          });
        }
        onMessage({ command: t, data: e }) {
          this.log("onMessage", t, e), "ready" !== t ? B.hasOwnProperty(t) && B[t](e) : this.onReady();
        }
        onReady() {
          this.log("ready"), (this.loaded = !0), this.saved.forEach((t) => this.post(...t)), (this.saved = []), this.post("version", { version: w["j"] });
          let t = "";
          Object(o["j"])() && (t = "Chrome"), Object(o["p"])() && (t = "Safari"), Object(o["l"])() && (t = "Edge"), this.post("userAgent", { browser: t });
        }
        post(t, e = {}) {
          if (!this.loaded) return this.log("post save", t, e), void this.saved.push([t, e]);
          if (!this.iframe) return;
          const s = { command: t, data: e };
      ...
      const Z = 0.6,
        ...
        et = [
          { name: J["a"].Intro, check: () => !r["a"].getters.hasProgress, next: J["a"].Mix, hide: () => g["a"].then("ELEMENT_DROP") },
          {
            name: J["a"].Mix,
            ...
            hide() {
              return new Promise((t) => {
                const e = () => {
                  tt().length < 2 || (g["a"].off("ELEMENT_DROP", e), g["a"].off("MIX_NEW", e), t());
                };
      ...
      class st {
        constructor() {
          (this.check = () => {
            if (r["a"].getters.isLoggedIn) return void g["a"].emit("TUTORIALS_FINISHED");
            ...
            (this.reset = () => {
              this.hide(), r["a"].dispatch("tutorialsFinished"), g["a"].off("PLAY", this.check), g["a"].off("WORKSPACE_CLEAR", this.reset), g["a"].off("LOGGED_IN", this.reset);
            });
        }
        init() {
        ...
        show(t) {
          r["a"].dispatch("tutorialShow", t.name),
            g["a"].emit("TUTORIALS_PROGRESS", { type: "start", name: t.name }),
            t.hide().then(() => {
              const e = this.getNext();
              this.hide(), g["a"].emit("TUTORIALS_PROGRESS", { type: "end", name: t.name }), e ? this.showNext(e) : window.setTimeout(() => r["a"].dispatch("tutorialsFinished"), 1e3 * Z);
            });
        }
      ...
      const vt = () => {
        ...
        wt = () => {
          clearTimeout(gt), (gt = null), (pt = 0), (Et = null), (yt = null), (ft = null), (bt = null);
        },
        It = (t) => {
          t.simulated ||
            ...
            (null !== bt && bt !== t.type) ||
            (null !== Et && Et !== t.target) ||
            (ht(t) && ((Et = t.target), (bt = t.type), clearTimeout(gt), (gt = window.setTimeout(wt, ut)), 0 !== pt || yt || (yt = { x: t.pageX, y: t.pageY })));
        },
        At = (t) => {
          ...
          const e = Object(lt["a"])(yt, { x: t.pageX, y: t.pageY });
          e > mt ? wt() : ((ft = t.type), clearTimeout(gt), (gt = window.setTimeout(wt, ut)), pt++, pt === dt && (vt(), wt()));
        };
      s("5319");
      const Tt = 1e3,
        St = 2;
      let _t,
        ...
        Lt = null;
      const Rt = () => {
          document.removeEventListener(`${Lt}move`, _t, !1), clearTimeout(xt), (xt = null), (Ot = null), (Lt = null);
        },
        Dt = () => {
        ...
        kt = (t) => {
          t.simulated ||
            ((null === Lt || t.type.includes(Lt)) &&
              (("mousedown" !== t.type && "pointerdown" !== t.type) || t.button === ct) &&
              ht(t) &&
              ((Ot = t.target),
              (Lt = t.type.replace("down", "").replace("start", "")),
              (Pt = { x: t.pageX, y: t.pageY }),
              (Ct = Pt),
              (xt = window.setTimeout(() => {
                Nt() ? Dt() : Rt();
              }, Tt)),
              (_t = (t) => {
                xt && (Ct = { x: t.pageX, y: t.pageY });
              }),
      ...
      class Bt {
        ...
        onDragStart(t) {
          null !== t && (Ht["a"].handler.disable(), this.$store.dispatch("dragStart", t));
        }
        onDragEnd(t, e = !1) {
          Ht["a"].handler.enable(), this.$store.dispatch("dragEnd", { position: t, simulated: e });
        }
        async onLibraryDistanceDragged(t, e, s, i, n) {
          ...
          (c && this.getWorkspaceBoxElement(r)) ||
            (this.$store.commit("DRAGGABLE_HELPER_RESET"), this.$store.dispatch("draggableHelperAdd", !0), (r = this.$store.getters.draggableHelperId), (c = this.$store.getters.draggableHelperElement), await Object(o["r"])()),
            this.$store.commit("DRAGGABLE_HELPER_PREPARE", { helper: c, elementId: t, position: a }),
            this.$store.commit("DRAGGABLE_HELPER_RESET"),
            this.simulateStartDrag({ id: r, dragPoint: s, startEventType: n });
        }
        ...
        simulateStartDrag({ id: t, dragPoint: { x: e, y: s }, startEventType: i }) {
          const n = { cancelable: !1, simulated: !0, pageX: e, pageY: s, clientX: e, clientY: s, startEventType: i },
      ...
      class Kt {
        ...
        testConnection() {
          return new Promise((t) => {
            ...
            e.open("HEAD", Yt), e.send(), (e.onprogress = () => t(!0)), (e.onload = () => t(!0)), (e.onerror = () => t(!1));
          });
        }
      }
      var zt = new Kt(),
      ...
      class ge {
        ...
        async fadeInMusic(t = ce, e = me) {
          if (this.canPlay(ee)) {
            ...
            this.music.gain.value !== s && this.setVolume(this.music.gain, pe), this.music.gain.exponentialRampToValueAtTime(s, this.context.currentTime + t);
          }
          await Object(o["c"])(1e3 * t);
        }
        async fadeOutMusic(t = ce) {
          this.music.gain.exponentialRampToValueAtTime(pe, this.context.currentTime + t), await Object(o["c"])(1e3 * t);
        }
        canPlay(t) {
      ...
      var Ee = ge;
      const fe = { name: "", type: null, url: null, buffer: null },
        be = Object(E["a"])(Object(E["a"])({}, fe), {}, { lazy: !0, loop: !1, mood: -1, duration: 0, fadeIn: 0, fadeOut: 0, volume: 100, silenceAfter: 0, prevents: [] }),
      ...
      class ve {
        ...
        add(t, e) {
          ...
          Object.entries(e).forEach(([e, a]) => {
            ...
            (r.name = e), (r.type = r.type || t), r.url && (r.url = `${i}${r.url}.${s}`), (this.sounds[e] = r);
          });
        }
        get(t) {
      ...
      var we = ve;
      const Ie = {
          click: { url: he, volume: 100 },
          pickup: { url: "PickUpItem", volume: 100 },
          drop: { url: "DropItem", volume: 100 },
          alreadymixed: { url: "AlreadyMixed", volume: 400 },
          clone: { url: "CloneItem", volume: 150 },
          failed: { url: "FailedToMix", volume: 80 },
          remove: { url: "RemoveItem", volume: 80 },
          charge: { url: "ChargeUp", volume: 10 },
          pop: { url: "PopUp", volume: 30 },
        },
        Ae = { DRAG_START: "pickup", ELEMENT_DROP: "drop", ELEMENT_CLONE: "clone", ELEMENT_DESTROY: "remove", MIX_MIXED: "alreadymixed", MIX_FAIL: "failed", MIX_NEW: "charge", ANIMATION_NEW_POP: "pop", BUTTON_CLICK: "click" };
      class Te {
        constructor(t) {
      ...
      var Se = Te;
      const _e = {
        LA_001: { type: ee, url: "LA_001", mood: ae, silenceAfter: 10, prevents: ["LA_001_loop"] },
        LA_002: { type: ee, url: "LA_002", mood: ae, silenceAfter: 10, prevents: ["LA_002_loop"] },
        LA_003: { type: ee, url: "LA_003", mood: ae, silenceAfter: 15, prevents: ["LA_003_loop"] },
        LA_FS_3_4: { type: ee, url: "LA_FS_3_4", mood: ae, silenceAfter: 10, prevents: ["LA_FS_3_4_loop"] },
        LA_004: { type: ee, url: "LA_004_Loop", loop: !0, mood: ne, duration: 320, volume: 70, silenceAfter: 6, fadeIn: 4, fadeOut: 4 },
        LA_005: { type: ee, url: "LA_005_Loop", loop: !0, mood: ne, duration: 246, volume: 70, silenceAfter: 20, fadeIn: 4, fadeOut: 4 },
        LA_006: { type: ee, url: "LA_006_Loop", loop: !0, mood: ae, duration: 180, silenceAfter: 6, fadeIn: 2, fadeOut: 2 },
        LA_FS_001: { type: ee, url: "LA_FS_001_Loop", loop: !0, mood: ne, duration: 200, volume: 70, silenceAfter: 10, fadeIn: 4, fadeOut: 4 },
        LA_FS_0032: { type: ee, url: "LA_FS_0032_Loop", loop: !0, mood: ne, duration: 60 },
        LA_001_loop: { type: se, url: "LA_001_Loop", loop: !0, mood: ne, duration: 50, volume: 50, silenceAfter: 6, fadeIn: 6, fadeOut: 6, prevents: ["LA_001"] },
        LA_002_loop: { type: se, url: "LA_002_Loop", loop: !0, mood: ne, duration: 100, volume: 50, silenceAfter: 15, fadeIn: 3, fadeOut: 6, prevents: ["LA_002"] },
        LA_003_loop: { type: se, url: "LA_003_Loop", loop: !0, mood: ne, duration: 90, volume: 50, silenceAfter: 10, fadeIn: 2, fadeOut: 5, prevents: ["LA_003"] },
        LA_FS_3_4_loop: { type: se, url: "LA_FS_3_4_Loop", loop: !0, mood: ne, duration: 64, volume: 50, silenceAfter: 10, fadeIn: 3, fadeOut: 6, prevents: ["LS_FS_3_4"] },
        [ie]: { type: se, buffer: [], duration: 20 },
      };
      var Oe = _e;
      const xe = 6e4,
        Pe = 15e4,
      ...
      class je {
        ...
        calculateRandomNext() {
          ...
          if (this.current.type === ee && this.current.mood === ae) return this.randomConnector();
      ...
      class Be {
        ...
        play(t) {
          ...
          this.isValid(e) &&
            ...
            this.current !== ie
              ? (this.playSource(e),
                0 !== this.currentDuration && (this.clearTimer(), (this.timer = window.setTimeout(this.durationReached, 1e3 * (this.currentDuration - this.pausedAt)))),
                e.fadeIn ? this.volume.fadeInMusic(e.fadeIn, e.volume) : this.volume.unmute(ee, e.volume))
              : window.setTimeout(() => {
        ...
        async onShow() {
          this.currentSound &&
            !this.isPlaying &&
            (await this.context.resume(), Object(o["q"])("music", "start on show", this.current), this.play(this.current), this.currentSound && !this.currentSound.fadeIn && this.volume.fadeInMusic(He, this.currentSound.volume));
        }
        async onHide() {
          this.isPlaying && (Object(o["q"])("music", "stop on hide", this.current), await this.volume.fadeOutMusic(He), await this.pause(), this.context.suspend(), this.clearTimer());
        }
        clearTimer() {
        ...
        init(t) {
          ...
          (this.player = new Fe(this, this.context, t)),
            ...
            g["a"].once("AUDIO_EXTENSION", () => {
              this.sounds.add(te, this.sfx.sounds), this.sounds.add(ee, this.music.sounds), window.setTimeout(() => this.sounds.loadAll(), 0);
            }),
      ...
      var Ue = new Ge(),
        We = s("6eebf");
      const Ye = { logged_in: "dimension1", music_active: "dimension2", sfx_active: "dimension3", engagement: "dimension4", progress: "dimension5" },
        Ke = { game_ready_timing: "metric1", session_progress: "metric2", total_progress: "metric3", fails_on_hints_click: "metric4" },
        ze = ["4", "5", "6", "10", "20", "30", "50", "75", "100", "150", "200", "250", "300", "400", "500"],
        Ve = (t) => {
          const e = ze.findIndex((e) => !(+e <= t)) || -1;
          return -1 === e ? null : ze[e - 1];
        },
        Xe = (t, e) => ({ trigger: t, handle: e }),
        qe = (t, e) => ({ watcher: t, handle: e }),
        Qe = [
          Xe("ANALYTICS_INIT", ({ send: t }) => t("metrics", "game_ready", null, null, null, !0)),
          ...
          Xe("TUTORIALS_FINISHED", ({ send: t }) => t("metrics", "tutorials_finished")),
      ...
      const Ze = [
          ...
          Xe("TUTORIALS_FINISHED", ({ set: t }) => t("engagement", "tutorials_finished")),
          Xe("TUTORIALS_PROGRESS", ({ set: t }, { type: e, name: s }) => t("engagement", `tutorial_${e}_${s}`)),
      ...
      class ls {
        constructor() {
          (this.setup = () => {
            ...
            (this.send = (t, e, s = null, i = null, n = null, a = !1) => {
              if (!window.ga) return;
              const r = {};
              a && (r.nonInteraction = !0), null === n ? window.ga("send", "event", t, e, s, i, r) : window.ga("send", "event", t, e, n, r), this.logger("[EVENT]", t, e, s, i, n, r);
            }),
            (this.set = (t, e) => {
              window.ga && (window.ga("set", cs[t], e), this.logger("[SET]", t, e));
            }),
            (this.sendTiming = (t, e) => {
        ...
        async init(t) {
          (this.$store = t), document.addEventListener(ot["c"], () => this.send("metrics", "not_ready_play_click", "timing", window.performance.now(), null, !0)), await g["a"].onReady(), this.setup();
        }
        setupTracker() {
          window.ga && window.ga("set", "transport", "beacon");
        }
        initHandlers() {
          const t = { send: this.send, set: this.set, timing: this.sendTiming, $store: this.$store };
          rs.forEach((e) => {
        ...
        handleErrors(t) {
          window.ga && window.ga("send", "exception", { exDescription: t.message || t, exFatal: !1 });
        }
        logger(...t) {
      ...
      var ps = s("baf5");
      g["a"].on("PLAY", () => ps["install"]({ onUpdateReady: () => ps["applyUpdate"]() }));
      var gs = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { attrs: { id: "app" } }, [t.isGameReady ? s("Popups") : t._e(), s("Game"), s("AudioExtension")], 1);
        },
        Es = [],
        fs = s("6e95"),
        bs = function () {
          ...
          return i(
            "div",
            { staticClass: "game", attrs: { id: "js-game" } },
            [
              i("Workspace"),
              i("Animations"),
              i("Library"),
              i("div", { staticClass: "ui" }, [i("Search"), i("Menu"), i("img", { staticClass: "logo", attrs: { alt: "Little Alchemy 2", src: s("1ae4") } })], 1),
        ...
        vs = function () {
          ...
          return s(
            "div",
            { staticClass: "workspace", class: t.classes, attrs: { id: t.WORKSPACE_ID }, on: { longpress: t.onLongpress } },
            [
              s("div", { ref: "element", staticClass: "workspace-cleanup" }),
              s("BoxSizing"),
              t._l(t.workspaceFinalWithoutAnimated, function (t) {
                return s("FinalBox", { key: t.id, attrs: { data: t, type: "final" } });
              }),
              t._l(t.workspaceExhaustedWithoutAnimated, function (t) {
                return s("FinalBox", { key: t.id, attrs: { data: t, type: "exhausted" } });
              }),
              t._l(t.workspaceElements, function (t) {
                return s("WorkspaceBox", { key: t.id, attrs: { data: t, "data-normal": "" } });
              }),
            ],
            2
          );
        ...
        Ss = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("Box", { class: t.classes, attrs: { data: t.data, "data-final": t.isFinal, "data-exhausted": t.isExhausted }, on: { click: t.onClick, touchstart: t.onClick } });
        },
        _s = [],
        Os = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", t._g({ staticClass: "element droppable", style: t.style }, t.$listeners), [s("img", { attrs: { src: t.iconUrl, alt: t.id } })]);
        },
        xs = [],
        Ps = s("fd41"),
        Cs = fs["a"].extend({
          ...
          computed: {
            ...
            style() {
              ...
              return { position: "absolute", top: `${e}px`, left: `${t}px` };
            },
          },
        }),
        Ls = Cs,
        ...
        ks = fs["a"].extend({
          ...
          computed: {
            ...
            classes() {
              return { "js-final": !this.isFinalAnimationActive && !this.isExhaustedAnimationActive, "js-exhausted": this.isExhausted };
            },
          },
          methods: {
            onClick() {
        ...
        Hs = function () {
          ...
          return s(
            ...
            [s("img", { ref: "icon", attrs: { src: t.iconUrl, alt: t.name, draggable: "false" }, on: { doubletap: t.onDoubleTap } })]
          );
        },
        Bs = [],
        Fs = s("b7ba");
      ...
      const Gs = Object(o["h"])("transform"),
        Us = { id: null, dragDistance: null, position: null, handle: null, type: Is["d"] },
        Ws = { mousedown: ["mousemove", "mouseup"], touchstart: ["touchmove", "touchend", "touchcancel", "mouseup"], pointerdown: ["pointermove", "pointerup", "pointercancel", "mouseup"] };
      class Ys {
        constructor(t, e = {}) {
          (this.handles = []),
            (this.throttle = !1),
        ...
        _create(t) {
          this.isWorkspace && (this.position = t.position ? t.position : this._getPosition()), (this.startPosition = Object(E["a"])({}, this.position)), this.setHandles();
        }
        get isWorkspace() {
        ...
        _getPosition() {
          ...
          if ("absolute" !== t.position || (e(t.left) && e(t.top))) {
            ...
            return (this.position = { x: t.left, y: t.top }), this.position;
          }
          return (this.position = { x: parseInt(t.left, 10), y: parseInt(t.top, 10) }), this.position;
        }
        handleEvent(t) {
          const e = `on${t.type}`;
          this[e] && this[e](t);
        ...
        startAnimatedDrag() {
          (this.helper = this.element), this.setLeftTop(), this.hasOwnProperty("onDragStart") && "function" === typeof this.onDragStart && this.onDragStart(this), Ft.onDragStart(this.id), this.animate();
        }
        _bindEvents(t) {
          t.forEach((t) => {
        ...
        _getTouch(t) {
          ...
          for (let e = 0, s = t.changedTouches.length; e < s; e++) if (this.pointerIdentifier === t.changedTouches[e].identifier) return t.changedTouches[e];
          return null;
        }
        onmousemove(t) {
          this.dragMove(t, t);
        ...
        dragMove(t, e) {
          ...
          if (this.isWorkspace || !this.options.dragDistance) (this.position.x = this.startPosition.x + s), (this.position.y = this.startPosition.y + i), (this.dragPoint.x = s), (this.dragPoint.y = i), Gt["a"].onDragMove(this.position);
          else {
            const t = Math.sqrt(s * s + i * i);
            t > this.options.dragDistance &&
              (this.dragEnd(), this.hasOwnProperty("onDistanceDragged") && "function" === typeof this.onDistanceDragged && this.onDistanceDragged(this.startPoint, this.dragPoint, this.startPosition, this.startEventType));
          }
        }
        onmouseup(t) {
          this.dragEnd(t);
        ...
        dragEnd(t) {
          (this.isDragging = !1),
            ...
            this._unbindEvents(),
            this.isWorkspace &&
              (this.helper && "none" !== this.helper.style.display && Gs && ((this.helper.style[Gs] = ""), this.setLeftTop()),
      ...
      var Ks = Ys,
        zs = fs["a"].extend({
          name: "workspace-box",
          props: { data: Object },
          data: () => ({ isDragging: !1, hover: !1, isClone: !1, cloned: !1 }),
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])(["elementById", "isArtModeEnabled", "draggingOverId", "mixFather", "mixStatus", "elementIsExhausted"])),
            {},
            {
              id() {
                return this.data.id;
          ...
          methods: {
            initDraggable() {
              (this.draggable = new Ks(this.$refs.element, { id: this.id, handle: [this.$refs.icon], type: Is["d"], position: Object(E["a"])({}, this.position) })),
        ...
        Qs = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return t.obtainSize ? s("Box", { ref: "box", attrs: { data: t.boxData } }) : t._e();
        },
        Js = [],
        Zs = fs["a"].extend({
          ...
          computed: {
            boxData() {
              return { id: "0", elementId: "0", position: { x: -200, y: -200 } };
            },
          },
          mounted() {
            this.updateSize(),
          ...
          methods: {
            ...
            notify(t, e) {
              this.$store.dispatch("dimensionsWorkspaceBox", { width: t, height: e });
            },
          },
        }),
        ti = Zs,
      ...
      var ni = fs["a"].extend({
          name: "workspace",
          components: { WorkspaceBox: qs, FinalBox: $s, BoxSizing: si },
          data: () => ({ listenerAdded: !1 }),
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])(["workspaceElements", "workspaceRevertable", "workspaceFinal", "workspaceExhausted", "isAnimationActive", "animationFinalFinished", "droppableById"])),
            {},
            {
              WORKSPACE_ID() {
                return Is["g"];
              ...
              classes() {
                return { "js-cleanup": this.ifAnimateClear || this.ifAnimateRevert, "js-revert": this.ifAnimateRevert };
              },
            }
          ),
          mounted() {
          ...
          watch: { ifAnimateClear: "addTransitionListener", ifAnimateRevert: "addTransitionListener" },
          methods: {
            ...
            addTransitionListener(t) {
              t && !this.listenerAdded && (this.$refs.element.addEventListener(ds["b"], this.onTransitionEnd, !1), (this.listenerAdded = !0));
            },
            ...
            onWorkspaceAnimationEnd() {
              this.$store.dispatch("animationReset"), this.$refs.element.removeEventListener(ds["b"], this.onTransitionEnd), (this.listenerAdded = !1);
            },
          },
        }),
        ai = ni,
        ...
        ci = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { ref: "element", staticClass: "side", attrs: { id: "side" } }, [
            t.isSortingEnabled
              ? s("div", [
                  s(
                    "button",
                    {
                      class: { "js-active": "alphabet" === t.sorting },
                      on: {
                        click: function (e) {
                  ...
                  s(
                    "button",
                    {
                      class: { "js-active": "timestamp" === t.sorting },
                      on: {
                        click: function (e) {
              ...
              : t._e(),
            s("div", { staticClass: "outer-library", attrs: { id: t.OUTER_LIBRARY_ID }, on: { longpress: t.onLongpress } }, [s("LibraryScroller", { ref: "scroller", attrs: { elements: t.libraryCurrentElements } })], 1),
          ]);
        },
        li = [],
      ...
      const mi = (t) => {
          ...
          return { width: n, height: a, x: s.left, y: s.top - e };
        },
        pi = (t) => {
          ...
          return { width: s, height: i, margin: n };
        };
      var gi = function () {
          var t = this,
            e = t.$createElement,
          ...
          return t.hasElements
            ? s(
                "div",
                { staticClass: "library", style: t.styles, attrs: { id: "library" } },
                [
                  t.shouldUseLiteBox
                    ? t._l(t.elementsList, function (e, i) {
                        return s("LibraryBoxLite", { key: i, style: t.getStyle(i), attrs: { element: e } });
                      })
                    : t._l(t.elementsList, function (e, i) {
                        return s("LibraryBox", { key: i, style: t.getStyle(i), attrs: { element: e } });
                      }),
                ],
                2
              )
        ...
        Ei = [],
          ...
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { ref: "element", staticClass: "element", class: t.classes, on: { click: t.onClick, touchstart: t.onClick } }, [
            s("img", { ref: "icon", attrs: { src: t.iconUrl, alt: t.name, draggable: "false", decoding: "async" } }),
            s("div", { staticClass: "elementName" }, [t._v(" " + t._s(t.name) + " ")]),
          ]);
        },
        bi = [],
        yi = fs["a"].extend({
          ...
          data: () => ({ animated: !1 }),
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])(["elementIsExhausted", "isExhaustedForIdActive"])),
            {},
            {
              iconUrl() {
              ...
              classes() {
                return { "js-exhausted": this.isExhausted, "js-animate": this.ifAnimateExhausted };
              },
            }
          ),
          mounted() {
          ...
          methods: {
            initDraggable() {
              (this.draggable = new Ks(this.$refs.element, { handle: [this.$refs.icon], type: Is["c"], dragDistance: Is["b"] })),
        ...
        Ai = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { ref: "element", staticClass: "element" }, [
            s("img", { ref: "icon", attrs: { src: t.iconUrl, alt: t.name, draggable: "false", decoding: "async" } }),
            s("div", { staticClass: "elementName" }, [t._v(" " + t._s(t.name) + " ")]),
          ]);
        },
      ...
      var Ri = fs["a"].extend({
          ...
          components: { LibraryBox: Ii, LibraryBoxLite: xi },
          data: () => ({ starting: 0, reloading: !1 }),
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])({ libraryElementsIds: "library", hasElements: "hasLibrary", isSearchActive: "isSearchActive", searchQuery: "searchQuery", inArtMode: "isArtModeEnabled", boxDimensions: "libraryBoxDimensions" })),
            {},
            {
              shouldUseLiteBox() {
              ...
              styles() {
                return { opacity: this.reloading ? 0 : 1, height: `${this.totalHeight}px`, contain: "layout" };
              },
              scrollerHeight() {
          ...
          watch: {
            ...
            async inArtMode(t) {
              t && (await Ht["a"].onInit(), Ht["a"].handler && Ht["a"].handler.refresh());
            },
            startIndex(t) {
              this._startIndex = t;
            },
          ...
          methods: {
            ...
            getStyle(t) {
              ...
              return { transform: `translate3d(0, ${s}px, 0)` };
            },
          },
        }),
        Di = Ri,
      ...
      var ji = fs["a"].extend({
          name: "library",
          components: { LibraryScroller: ki },
          data: () => ({ OUTER_LIBRARY_ID: ui["b"], outerHeight: 0, elementOuterHeight: 0 }),
          computed: Object(E["a"])(
            Object(E["a"])(
              {},
              Object(r["b"])({ libraryElementsIds: "library", hasElements: "hasLibrary", elementById: "elementById", isSearchActive: "isSearchActive", searchQuery: "searchQuery", hasEmptyLibrary: "hasEmptyLibrary", sorting: "librarySortBy" })
            ),
            {},
            {
              elements() {
          ...
          methods: {
            ...
            updateDroppableData() {
              ...
              this.$store.commit("STATIC_DROPPABLE_UPDATE", Object(E["a"])({ id: Is["e"] }, t));
            },
            ...
            refreshScroll() {
              ...
              e < t * this.elementHeight && (e = t * this.elementHeight + 20), Ht["a"].handler && Ht["a"].handler.refresh && Ht["a"].handler.refresh(e);
            },
            libraryRendered() {
              return new Promise((t) => {
                const e = this.$watch(
        ...
        Fi = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("label", { ref: "container", attrs: { for: "search-input", id: t.SEARCH_BAR_ID } }, [
            s("input", { ref: "input", staticClass: "search-bar", class: t.classes, attrs: { type: "text", id: "search-input", maxlength: "20", tabindex: t.tabIndex }, on: { blur: t.hide, keyup: t.onKeyUp } }),
            s("div", { staticClass: "search icon", class: t.iconClasses, on: { click: t.toggle } }, [t.isActive ? s("IconClose", { staticClass: "close-search-icon" }) : s("IconSearch")], 1),
          ]);
        },
        Gi = [],
        Ui = s("06c5"),
      ...
      var zi = {
        ...
        render(t, e) {
          ...
          return s(
            "svg",
            Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-search", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
            a.concat([
              s("path", { attrs: { d: "M26.3 10.08a16.2 16.2 0 11-11.47 4.75 16.1 16.1 0 0111.46-4.75m0-3a19.2 19.2 0 1013.54 5.62A19.15 19.15 0 0026.3 7.08z" } }),
              s("path", {
                attrs: {
                  d:
                    "M26.3 3a23.3 23.3 0 0116.45 39.75A23.3 23.3 0 019.82 9.82 23.13 23.13 0 0126.3 3m0-3a26.3 26.3 0 1018.57 7.7A26.2 26.2 0 0026.3 0zm25.85 48.53l8.14 8.14a2.5 2.5 0 010 3.54l-.1.1a2.5 2.5 0 01-3.57 0l-8.13-8.1 3.63-3.62m0-3.84a1 1 0 00-.68.3L45 51.47a1 1 0 000 1.35l9.6 9.6a5.5 5.5 0 007.77 0l.1-.1a5.5 5.5 0 000-7.78L52.82 45a1 1 0 00-.68-.28z",
                },
              }),
              s("path", { staticClass: "svg-n svg-m", attrs: { d: "M48.93 48.93l-4.3-4.3" } }),
            ])
          );
        },
      };
      ...
      var Xi = {
          ...
          render(t, e) {
            ...
            return s(
              "svg",
              Object(E["a"])({ class: ["close-icon", r, o], style: [c, l], attrs: Object.assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
              a.concat([s("path", { staticClass: "cls-1", attrs: { d: "M5 59L59 5" } }), s("path", { staticClass: "cls-1", attrs: { d: "M5 5l54 54" } })])
            );
          },
        },
        qi = fs["a"].extend({
          name: "search-bar",
          components: { IconSearch: zi, IconClose: Xi },
          computed: Object(E["a"])(
            Object(E["a"])(
              {},
              Object(r["b"])({ isActive: "isSearchActive", query: "searchQuery", isPopupActive: "isPopupActive", isTutorialFinished: "areTutorialsFinished", isAnimationActive: "isAnimationActive", isArtModeEnabled: "isArtModeEnabled" })
            ),
            {},
            {
              tabIndex() {
              ...
              classes() {
                return { "js-hidden": !this.isActive, "js-visible": this.isActive };
              },
              iconClasses() {
                return { "js-hidden": !this.isTutorialFinished };
              },
          ...
          methods: {
            ...
            onKeyUp(t) {
              ...
              if (this.isActive && t.keyCode === Ui["d"]) return t.preventDefault(), void this.hide();
            ...
            show(t = !1) {
              ...
              e && (this.$store.dispatch("searchShow"), this.$refs.input.focus(), Ht["a"].savePosition(), t && this.emitSound(), Object(o["p"])() && Object(o["n"])() && document.addEventListener("touchstart", this.blurHackForIOS));
            },
            emitSound() {
            ...
            onHide() {
              this.$refs.input.blur(), (this.$refs.input.value = ""), Ht["a"].applyPosition(), Object(o["p"])() && Object(o["n"])() && document.removeEventListener("touchstart", this.blurHackForIOS);
            },
            blurHackForIOS(t) {
        ...
        tn = function () {
          ...
          return s(
            ...
            [
              s(
                "MenuButton",
                { staticClass: "no-highlight", attrs: { active: !t.workspaceRevertable, alwaysShow: !0, alwaysAnimate: !0, primaryText: "clean up", secondaryText: "revert" }, on: { click: t.onClearRevert } },
                [s("IconClear", { staticClass: "menu-button-icon primary", attrs: { slot: "primary" }, slot: "primary" }), s("IconRevert", { staticClass: "menu-button-icon secondary", attrs: { slot: "secondary" }, slot: "secondary" })],
                1
              ),
              s(
                "MenuButton",
                { attrs: { active: !t.isSettingsActive, primaryText: "settings", secondaryText: "close" }, on: { click: t.toggleSettings } },
                [s("IconSettings", { staticClass: "menu-button-icon primary", attrs: { slot: "primary" }, slot: "primary" }), s("IconClose", { staticClass: "menu-button-icon secondary", attrs: { slot: "secondary" }, slot: "secondary" })],
                1
              ),
              s(
                "MenuButton",
                { staticClass: "tight", attrs: { active: !t.isEncyclopediaActive, primaryText: "encyclopedia", secondaryText: "close" }, on: { click: t.toggleEncyclopedia } },
                [
                  s(
                    "div",
                    { attrs: { slot: "additional" }, slot: "additional" },
                    [
                      s("div", { staticClass: "badge-container" }, [s("span", { staticClass: "badge", class: { "js-hide": 0 === t.newInEncyclopediaCount } }, [t._v(" " + t._s(t.newInEncyclopediaCount || "") + " ")])]),
                      s("AnimationFinalEncyclopedia"),
                    ],
                    1
                  ),
                  s("IconEncyclopedia", { staticClass: "menu-button-icon primary", attrs: { slot: "primary" }, slot: "primary" }),
                  s("IconClose", { staticClass: "menu-button-icon secondary", attrs: { slot: "secondary" }, slot: "secondary" }),
                ],
                1
              ),
              s("a", { staticClass: "menu-button primary js-in", attrs: { href: t.HINTS_URL, target: "_blank", title: "Little Alchemy 2 Official Cheats", rel: "noopener" }, on: { click: t.onHintsClick } }, [
                s("div", { staticClass: "menu-button-icon-container" }, [s("IconHints", { staticClass: "menu-button-icon primary" })], 1),
                t._m(0),
              ]),
            ],
            1
        ...
        en = [
          function () {
            var t = this,
              e = t.$createElement,
              s = t._self._c || e;
            return s("div", { staticClass: "menu-button-label-container" }, [s("div", { staticClass: "menu-button-label primary" }, [t._v("hints")])]);
          },
        ],
        sn = function () {
          var t = this,
            e = t.$createElement,
            s = t._self._c || e;
          return s("div", { staticClass: "materialize-container" }, [
            s("div", { directives: [{ name: "animation-end", rawName: "v-animation-end", value: t.onAnimation, expression: "onAnimation" }], staticClass: "materialize", class: t.classes, attrs: { id: t.id } }, [
              s("div", { staticClass: "core" }),
              s("div", { staticClass: "core2" }),
            ]),
          ]);
        },
        nn = [];
      ...
      var rn = fs["a"].extend({
          ...
          computed: {
            ...
            classes() {
              return { "js-active": this.isActive };
            },
          },
          mounted() {
      ...
      var dn = {
        ...
        render(t, e) {
          ...
          return s(
            "svg",
            Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-clear", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
            a.concat([
              s("g", [
                s("path", {
                  attrs: {
                    d:
                      "M23.13 18.13a3.55 3.55 0 012.5 1L44.53 38a3.53 3.53 0 01.53 4.27L29 58.3 5.3 34.6l16-16a3.53 3.53 0 011.8-.46m0-3a6.44 6.44 0 00-3.7 1.12L1.07 34.62 29 62.52l18.37-18.35a6.5 6.5 0 00-.72-8.3L27.75 17a6.56 6.56 0 00-4.62-1.85z",
                  },
                }),
                s("path", { staticClass: "svg-n svg-m", attrs: { d: "M46.36 44.6L19 17.3M8.76 41.2l17.1-17.08M20.38 52.8l7.52-7.5" } }),
                s("path", { attrs: { d: "M58.86 3.74a1.1 1.1 0 01.76.28 1.08 1.08 0 010 1.52L38 27.12l-1.5-1.52L58.1 4a1.1 1.1 0 01.77-.28m0-3A4.08 4.08 0 0056 1.9L32.25 25.6 38 31.36l23.75-23.7a4 4 0 00-2.9-6.92z" } }),
              ]),
              s("circle", { staticClass: "svg-n svg-m", attrs: { cx: "50", cy: "56", r: "2.83" } }),
            ])
          );
        },
      };
      ...
      var mn = {
        ...
        render(t, e) {
          ...
          return s(
            "svg",
            Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-encyclopedia", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
            a.concat([
              s("path", {
                attrs: {
                  d:
                    "M55.86 7.12a3 3 0 002.54 1.4H61v38.7h-9.77l-11.83-.1h-2.8a3 3 0 00-2.68 1.66 2.13 2.13 0 01-1 1h-.08a2.12 2.12 0 01-1 .25 2.55 2.55 0 01-2.22-1.33A3 3 0 0027 47.12H3V8.92h2.1a3 3 0 002.75-1.8h16.4a5.73 5.73 0 014.83 3 3 3 0 002.62 1.54A3 3 0 0034.34 10a5.35 5.35 0 014.76-2.88h16.76m1.54-3H39.1a8.36 8.36 0 00-7.4 4.5 8.76 8.76 0 00-7.4-4.5H6.1a.94.94 0 00-1 1v.8H1a.94.94 0 00-1 1v42.2a.94.94 0 001 1h26A5.56 5.56 0 0031.86 53a5.4 5.4 0 004.74-2.9h2.8l11.8.1H63a.94.94 0 001-1V6.5a1 1 0 00-1-1h-4.6v-.4a.94.94 0 00-1-1z",
                },
              }),
              s("path", { staticClass: "svg-b svg-m bookmark", attrs: { d: "M54.1 33.62v25.2a.87.87 0 01-.9 1 1.85 1.85 0 01-.7-.2l-5.2-4.5-5.3 4.5a1 1 0 01-1.4-.1.9.9 0 01-.3-.7v-25.2z" } }),
              s("path", { staticClass: "svg-b", attrs: { d: "M31.7 45.56A8 8 0 0025.9 43H6.5V5.62h17.8a7.2 7.2 0 016.1 3.73l1.32 2.4L33 9.33a6.83 6.83 0 016.1-3.7h17.8V43H37.5a8 8 0 00-5.8 2.56z" } }),
              s("path", {
                attrs: {
                  d:
                    "M55.4 7.12v34.4H37.5a9.5 9.5 0 00-5.8 2 9.5 9.5 0 00-5.8-2H8V7.12h16.25a5.73 5.73 0 014.83 3l2.67 4.8 2.6-4.92a5.35 5.35 0 014.75-2.88h16.3m2-3H39.1a8.36 8.36 0 00-7.4 4.5 8.76 8.76 0 00-7.4-4.5H6a.94.94 0 00-1 1v38.4a.94.94 0 001 1h19.9a6.5 6.5 0 015 2.4.55.55 0 00.5.3h.6a.85.85 0 00.5-.3 6.5 6.5 0 015-2.4h19.9a.94.94 0 001-1V5.12a.94.94 0 00-1-1z",
                },
              }),
              s("path", { staticClass: "svg-n svg-j", attrs: { d: "M31.7 9.5v36" } }),
              s("g", { staticClass: "lines" }, [
                s("path", { attrs: { d: "M25.91 14H10.33a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M25.91 21.54H10.33a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M25.91 29.11H10.33a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M25.91 36.69H10.33a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M52.92 14H37.34a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M52.92 21.54H37.34a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M52.92 29.11H37.34a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
                s("path", { attrs: { d: "M52.92 36.69H37.34a1 1 0 010-2h15.58a1 1 0 010 2z" } }),
              ]),
            ])
          );
        },
      ...
      var gn = {
        ...
        render(t, e) {
          ...
          return s(
            "svg",
            Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-hints", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
            a.concat([
              s("g", { staticClass: "lines" }, [
                s("path", { staticClass: "line-r", attrs: { d: "M61.64 31.9h-4.08a1.33 1.33 0 110-2.67h4.09a1.33 1.33 0 110 2.67z" } }),
                s("path", { staticClass: "line-l", attrs: { d: "M6.44 31.9H2.36a1.33 1.33 0 010-2.67h4.08a1.33 1.33 0 010 2.67z" } }),
                s("path", { staticClass: "line-rt", attrs: { d: "M50.06 14.1a1.33 1.33 0 01-.94-2.28L52 9a1.33 1.33 0 111.87 1.9L51 13.72a1.33 1.33 0 01-.94.38z" } }),
                s("path", { staticClass: "line-lb", attrs: { d: "M11 52.56a1.33 1.33 0 01-.94-2.28L13 47.41a1.33 1.33 0 011.87 1.9L12 52.18a1.33 1.33 0 01-1 .38z" } }),
                s("path", { staticClass: "line-t", attrs: { d: "M32 6.74a1.33 1.33 0 01-1.33-1.33V1.33a1.33 1.33 0 112.67 0v4.08A1.33 1.33 0 0132 6.74z" } }),
                s("path", { staticClass: "line-lt", attrs: { d: "M13.94 14.1a1.33 1.33 0 01-.94-.38l-2.9-2.87A1.33 1.33 0 1112 9l2.91 2.86a1.33 1.33 0 01-.94 2.28z" } }),
                s("path", { staticClass: "line-rb", attrs: { d: "M53 52.56a1.33 1.33 0 01-.94-.38l-2.91-2.86A1.33 1.33 0 1151 47.41l2.91 2.86a1.33 1.33 0 01-.91 2.29z" } }),
              ]),
              s("path", { attrs: { d: "M32 50.81a20.12 20.12 0 01-20.25-19.94 20.25 20.25 0 0140.5 0A20.12 20.12 0 0132 50.81z" } }),
              s("path", { staticClass: "svg-b", attrs: { d: "M32 13.59a17.45 17.45 0 00-17.58 17.28 17.58 17.58 0 0035.16 0A17.45 17.45 0 0032 13.59z" } }),
              s("path", { attrs: { d: "M38.59 57H25.41a1.33 1.33 0 110-2.67h13.18a1.33 1.33 0 110 2.67z" } }),
              s("path", { attrs: { d: "M35.43 64h-6.86a1.33 1.33 0 010-2.67h6.87a1.33 1.33 0 010 2.67z" } }),
            ])
          );
        },
      };
      ...
      var fn = {
        ...
        render(t, e) {
          ...
          return s(
            "svg",
            Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-revert", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
            a.concat([
              s("path", { staticClass: "svg-n svg-c svg-j", attrs: { d: "M36.4 53.5h9.9a15.6 15.6 0 100-31.22h-44" } }),
              s("path", { staticClass: "svg-n svg-c svg-j", attrs: { d: "M2.3 22.3l11.8-11.8" } }),
              s("path", { staticClass: "svg-n svg-c svg-j", attrs: { d: "M2.1 22.3l11.8 11.8" } }),
            ])
          );
        },
      };
      ...
      var yn = {
          ...
          render(t, e) {
            ...
            return s(
              "svg",
              Object(E["a"])({ class: [r, o], style: [c, l], attrs: Object.assign({ id: "icon-settings", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 64 64" }, h) }, d),
              a.concat([
                s("path", { staticClass: "svg-n svg-m svg-c", attrs: { d: "M63 15H1m62 17H1m62 17H1" } }),
                s("ellipse", { staticClass: "svg-b svg-c", attrs: { cx: "14", cy: "15", rx: "6", ry: "6.06" } }),
                s("ellipse", { staticClass: "svg-b svg-c", attrs: { cx: "32", cy: "32", rx: "6", ry: "6.06" } }),
                s("ellipse", { staticClass: "svg-b svg-c", attrs: { cx: "50", cy: "49", rx: "6", ry: "6.06" } }),
              ])
            );
          },
        },
        vn = function () {
          ...
          return s(
            "div",
            { staticClass: "menu-button", class: t.classes, on: { click: t.onClick } },
            [
              t._t("additional"),
              s("div", { staticClass: "menu-button-icon-container" }, [t._t("primary"), t._t("secondary")], 2),
              s("div", { staticClass: "menu-button-label-container" }, [
                s("div", { staticClass: "menu-button-label primary" }, [t._v(t._s(t.primaryText))]),
                s("div", { staticClass: "menu-button-label secondary" }, [t._v(t._s(t.secondaryText))]),
              ]),
            ],
            2
          );
      ...
      var An = fs["a"].extend({
          name: "menu-button",
          props: {
            active: { type: Boolean, required: !1, default: !0 },
            primaryText: { type: String, required: !0 },
            secondaryText: { type: String, required: !1, default: "" },
            alwaysShow: { type: Boolean, required: !1, default: !1 },
            alwaysAnimate: { type: Boolean, required: !1, default: !1 },
          },
          data: () => ({ animating: !1 }),
          computed: {
            classes() {
              const t = this.alwaysAnimate ? this.animating : this.isPrimary;
              return { primary: this.isPrimary || (this.alwaysAnimate && this.animating), secondary: !this.active && this.hasSecondary && (!this.alwaysAnimate || !this.animating), back: !this.alwaysShow && this.hasSecondary, "js-in": t };
            },
            isPrimary() {
          ...
          methods: {
            ...
            async handleAnimation() {
              this.alwaysAnimate && ((this.animating = !0), await Object(o["c"])(In), this.onAnimationEnd());
            },
            onAnimationEnd() {
              this.animating = !1;
            },
        ...
        On = fs["a"].extend({
          name: "menu-custom",
          components: { AnimationFinalEncyclopedia: ln, MenuButton: _n, IconClear: dn, IconClose: Xi, IconEncyclopedia: mn, IconHints: gn, IconRevert: fn, IconSettings: yn },
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])(["isPopupWithNameActive", "encyclopediaTimestamp", "workspaceRevertable", "progressSince"])),
            {},
            {
              HINTS_URL() {
                return w["f"];
          ...
          methods: {
            ...
            toggleSettings() {
              this.isPopupWithNameActive(v["SETTINGS"]) ? g["a"].emit("SETTINGS_HIDE") : g["a"].emit("SETTINGS_SHOW"), this.toggle(v["SETTINGS"]);
            },
            toggleEncyclopedia() {
            ...
            toggleHints() {
              this.isPopupWithNameActive(v["SYNC"]) || (window.open(w["f"], "_blank"), this.onHintsClick());
            },
            onHintsClick() {
        ...
        Ln = function () {
          var t = this,
            e = t.$createElement,
            i = t._self._c || e;
          return i("div", { staticClass: "text-tutorials-container", class: t.containerClasses }, [
            i("div", { staticClass: "text-tutorials", class: t.classes }, [
              i("div", { staticClass: "close", on: { click: t.hide } }, [i("img", { staticClass: "label", attrs: { src: s("2260"), alt: "close" } })]),
              i("div", { staticClass: "content", domProps: { innerHTML: t._s(t.text) } }),
            ]),
          ]);
        },
        Rn = [],
      ...
      var jn = fs["a"].extend({
          name: "text-tutorials",
          data: () => ({ textCopy: "", containerClassesCopy: [] }),
          computed: Object(E["a"])(
            Object(E["a"])({}, Object(r["b"])(["tutorialTextCurrent", "tutorialTextPosition"])),
            {},
            {
              classes() {
                return { "js-active": null !== this.tutorialTextCurrent };
              },
              containerClasses() {
          ...
          watch: {
            tutorialTextCurrent(t) {
              if (!t) return;
              let e;
              (e = Object(Dn["b"])(t.text) ? t.text : t.text(this.$store.getters)), (this.textCopy = e);
            },
          },
          methods: {
            hide() {
        ...
        Fn = fs["a"].extend({
          name: "game",
          components: { Workspace: oi, Library: Bi, Search: Zi, Menu: Cn, Tutorials: () => s.e("tutorials").then(s.bind(null, "735f")), TextTutorials: Bn, Animations: () => s.e("animations").then(s.bind(null, "407f")) },
          computed: {
            areTutorialsVisible() {
        ...
        Kn = [
          function () {
            var t = this,
              e = t.$createElement,
              s = t._self._c || e;
            return s("audio", { attrs: { id: t.id, preload: "metadata" }, on: { loadedmetadata: t.onMetaData } }, [s("source", { attrs: { src: t.srcOGG, type: "audio/ogg" } }), s("source", { attrs: { src: t.srcM4A, type: "audio/mpeg" } })]);
          },
        ],
        zn = fs["a"].extend({
        ...
        Qn = fs["a"].extend({
          name: "app",
          components: { Game: Wn, Popups: () => s.e("popups").then(s.bind(null, "59a1")), AudioExtension: qn },
          computed: {
            isGameReady() {
      ...
      (a["a"].config.productionTip = !1),
        ...
        new a["a"]({ store: r["a"], el: "#app", render: (t) => t(ta) }),
        c["a"].init(new m()),
        p["a"].init(r["a"]),
        g["a"].init(r["a"]),
        N.init(r["a"]),
        ...
        Object(o["b"])(() => {
          at["a"].init(r["a"]),
            ...
            We["a"].init(r["a"]),
            Object(o["b"])(() => {
              nt["a"].init(r["a"]), zt.init(r["a"]), Vt["a"].init(r["a"]), Qt.init(r["a"]), $["a"].init(r["a"]), Zt.init(r["a"]), Ue.init(r["a"]), hs.init(r["a"]);
            });
        });
    },
    cd57: function (t, e, s) {
    ...
    d257: function (t, e, s) {
      ...
      const n = (t, e = "animationend") =>
        ...
        r = (t, e) => (t.addEventListener(i["a"], e, !1), () => t.removeEventListener(i["a"], e)),
      ...
      const u = ["Webkit", "Moz", "ms", "Ms", "O"],
        ...
        g = (t) => {
          ...
          let s;
          for (let i = 0, n = u.length; i < n; i++) if (((s = u[i] + e), "string" === typeof m[s])) return s;
          return t;
        },
        E = (t) => {
      ...
      const P = (t, ...e) => {},
        ...
        H = (t) => {
          ...
          return { days: i, hours: n, minutes: a };
        },
        B = (t) => {
    ...
    da98: function (t, e, s) {
      "use strict";
      var i = s("5530");
      const n = { id: "", name: "", description: "", parents: [], children: [], tags: [], prime: !1, base: !1, final: !1, exhausted: null, condition: null };
      var a = n;
      s.d(e, "a", function () {
        return r;
      }),
      ...
      const r = (t, e) => t.hasOwnProperty(e),
        ...
        c = (t, e) => {
          const s = t.name || t.n || "",
            n = t.parents || t.p || [],
            r = t.children || t.c || [];
          return delete t.n, delete t.c, delete t.p, Object(i["a"])(Object(i["a"])(Object(i["a"])({}, a), t), {}, { id: e, name: s, children: r, parents: n, final: !r.length });
        };
    },
    ded8: function (t, e, s) {
      "use strict";
