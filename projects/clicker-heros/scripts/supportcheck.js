...
(function () {
  ...
  if (missingFeatures.length === 0 && !isKasperskyScriptInjected) window["C3_IsSupported"] = true;
    ...
    if (/android/i.test(ua))
      ...
      msgText += "<br><br>Note: <strong>Internet Explorer</strong> is not supported. Try using <a href='https://www.google.com/chrome'>Chrome</a> or <a href='https://www.mozilla.org/firefox'>Firefox</a> instead.";
